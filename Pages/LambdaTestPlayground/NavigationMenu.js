...
class NavigationMenu //Top navigation area of the website
{
    constructor(page) {
        ...
        this.locators = {
            ...
            navAddOns: '//*[contains(@class, "title") and normalize-space(text())="AddOns"]',
            navMyAccount: '(//*[contains(@class, "title") and normalize-space(text())="My account"])[2]',
            ...
            buttonSearch: '//button[contains(@type,"submit") and normalize-space(text())="Search"]',
            ...
            optionLoginInMyAccount: '//*[contains(@class, "title") and normalize-space(text())="Login"]',
            optionRegisterInMyAccount: '//*[contains(@class, "title") and normalize-space(text())="Register"]',
